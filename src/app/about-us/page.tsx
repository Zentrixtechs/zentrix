...
export default function AboutUs() {
  return (
    <>
      {/* ================= HERO ================= */}
      <section className="bg-gradient-to-r from-[#F028C2] to-[#2D96EB] text-white py-6 text-center shadow-lg">
      ...
      {/* ================= BIG OR SMALL ================= */}
      <section className="bg-gradient-to-br from-[#F028C2] to-[#2D96EB] text-white py-16">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
            <div className="lg:col-span-2">
              <h2 className="text-3xl font-bold mb-4">
                Big or small ? We <br />
                <span className="text-white underline decoration-[#2D96EB] underline-offset-8">have a plan</span>
              </h2>
            ...
            {[
              ...
              <div key={item.title} className="border-t border-white/30 pt-5">
                ...
                <h4 className="font-semibold mb-2 text-white/90">{item.heading}</h4>
                <p className="text-white/80 text-sm">{item.desc}</p>
              </div>
            ))}
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 lg:px-10 text-center">
          <p className="text-[#F028C2] font-semibold mb-2">
            Why choose us
          </p>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div className="space-y-4">
            {[
              ...
              <div
                key={i}
                className="bg-gradient-to-r from-[#F028C2] to-[#2D96EB] text-white rounded-xl p-5 relative shadow-md"
              >
                <span className="absolute top-4 right-4 text-4xl font-bold text-white/20">
                  {i + 1}
                </span>
