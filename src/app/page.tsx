...
const GRADIENTS = {
  ...
  border: ["border-[#ff2f92]", "border-[#00f0ff]", "border-[#3b82f6]"],
};
...
function CountUp({ end }: { end: number }) {
  ...
  useEffect(() => {
    const observer = new IntersectionObserver(
      ...
      { rootMargin: "0px 0px -50px 0px" } // Start slightly earlier
    );
...
export default function Home() {
  const logoColors = GRADIENTS.border;
  ...
  return (
    <main className="overflow-x-hidden bg-white">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <Reveal delay={300}>
                <div className="mt-10 flex gap-4 flex-col sm:flex-row">
                  <Link
                    href="/contact"
                    className={`group inline-flex items-center gap-3 px-5 py-2.5 rounded-lg text-white text-sm font-semibold bg-gradient-to-r ${GRADIENTS.cta} transition-all duration-300 hover:scale-[1.05] hover:shadow-[0_0_20px_rgba(240,40,194,0.4)]`}
                  >
                  ...
                  <Link
                    href="#services"
                    className="inline-flex items-center justify-center px-5 py-2.5 text-sm font-semibold rounded-lg border border-gray-300 text-black hover:bg-gray-100 transition"
                  >
                    Explore Services
                  </Link>
                </div>
            ...
            <Reveal delay={200}>
              <div className="relative w-full max-w-lg mx-auto animate-float">
                <Image
                  src={HERO_IMAGE}
                  alt="Zentrix Digital Marketing Growth"
                  width={800}
                  height={500}
          ...
          {[{ value: 500, label: "Happy Clients" }, { value: 1000, label: "Projects Delivered" }, { value: 10, label: "Years Experience" }].map((item, i) => (
            <Reveal key={i} delay={i * 120}>
              <div className="bg-white border border-[#00f0ff]/30 rounded-2xl py-10 shadow-xl hover:border-[#ff2f92] hover:shadow-2xl hover:scale-105 transition-all">
                ...
                <p className="mt-3 text-black/60 tracking-widest uppercase text-sm">{item.label}</p>
              </div>
            </Reveal>
          ))}
        </div>
          ...
          <div className="overflow-hidden">
            <div className="flex gap-8 items-center animate-marquee hover:pause">
              {SERVICE_ICONS.concat(SERVICE_ICONS).map((service, i) => (
                <div
                  key={i}
                  className={`service-card flex-shrink-0 p-5 rounded-xl border ${logoColors[i % logoColors.length]} bg-white text-center hover:scale-105 transition`}
      ...
      {/* ================= SERVICES ================= */}
      <section id="services" className="py-28 bg-gradient-to-br from-[#f9fbff] via-[#eef6ff] to-[#fdf2ff] relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute -top-40 -left-40 w-[500px] h-[500px] bg-[#ff2f92]/10 rounded-full blur-3xl" />
          <div className="absolute top-1/2 -right-40 w-[500px] h-[500px] bg-[#00f0ff]/10 rounded-full blur-3xl" />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <Reveal>
            <h2 className="text-4xl md:text-5xl font-bold text-center text-black">
              Our <span className={`bg-gradient-to-r ${GRADIENTS.heading} bg-clip-text text-transparent`}>Services</span>
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-10 mt-20">
            {[
              { title: "Digital Marketing", img: "/images/metaads.png", desc: "Grow your business online with SEO, social, email and paid advertising that drives leads and revenue.", link: "/marketing/digital-marketing" },
              { title: "Web Development", img: "/images/webdevelopment.png", desc: "High-converting websites, UX designs and landing pages that increase trust and conversions.", link: "/services/websites-development" },
              { title: "Logo Design & Branding", img: "/images/logodesign.png", desc: "Unique brand identity, logos and visual systems that build authority and recall.", link: "/services/logo-design" },
              { title: "SEO", img: "/images/seo.png", desc: "Search engine optimization that ranks your business and brings consistent organic leads.", link: "/services/seo" },
              { title: "Google Ads", img: "/images/googleads.png", desc: "High ROI Google Ads campaigns with precision keyword and audience targeting.", link: "/services/ads/google-ads" },
              { title: "Facebook & Instagram Ads", img: "/images/metaads.png", desc: "Creative paid ads that drive awareness, leads and sales on Meta platforms.", link: "/services/ads/meta-ads" },
            ].map((service, i) => (
              <Reveal key={i} delay={i * 120}>
                <div className="group h-[520px] flex flex-col justify-between rounded-2xl border border-[#00f0ff]/30 bg-white hover:border-[#ff2f92] hover:shadow-2xl transition-all">
                  ...
                  <div className="p-6 flex justify-center">
                    <Image src={service.img} alt={service.title} width={140} height={140} className="object-contain" />
                  </div>
                  ...
                  <div className="px-8 pb-8">
                    <Link href={service.link} className={`inline-flex items-center gap-2 text-sm font-semibold bg-clip-text text-transparent bg-gradient-to-r ${GRADIENTS.heading}`}>
        ...
        <div className="max-w-7xl mx-auto px-6 text-center">
          <Reveal>
            <h2 className="text-4xl md:text-5xl font-bold text-black">
              We Offer a{" "}
              <span className={`bg-gradient-to-r ${GRADIENTS.cta} bg-clip-text text-transparent`}>
                360° Marketing Plan
              </span>{" "}
              for Your Growth
            </h2>
          ...
          <Reveal delay={250}>
            <div className="mt-16 flex justify-center">
              <Image
                ...
                alt="360° Marketing Funnel by Zentrix"
                width={850}
                height={900}
      ...
      <section className="py-32 bg-gradient-to-br from-[#f9fbff] via-[#eef6ff] to-[#fdf2ff] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative">
          <Reveal>
            <h2 className="text-4xl md:text-5xl font-bold text-center text-black">
              Pricing <span className={`bg-gradient-to-r ${GRADIENTS.heading} bg-clip-text text-transparent`}>Packages</span>
            </h2>
      ...
      <section className="py-24 bg-gradient-to-r from-[#ff2f92] via-[#00f0ff] to-[#3b82f6] text-white">
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          <Reveal delay={300}>
            <Link
              href="/contact"
              className="inline-block mt-8 px-8 py-4 bg-white text-black rounded-lg font-semibold hover:scale-105 transition-transform"
            >
