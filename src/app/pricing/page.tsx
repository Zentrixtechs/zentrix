        ...
        <table className="w-full border bg-white">
          <thead>
            <tr>
              ...
              <PlanHead title="Starter" price="$500" />
              <PlanHead title="Growth" price="$2000" popular />
              <PlanHead title="Advanced" price="$4000" />
            </tr>
          </thead>

          <tbody>
            <Row label="Target Area" values={["Local", "Nationwide", "Global"]} />
            <IconRow label="Technical SEO" checks={[true, true, true]} />
            <IconRow label="Monthly Reports" checks={[true, true, true]} />
          </tbody>
        </table>
      </div>
    </section>
...
function MetaAdsPricing() {
  return (
    <section className="py-20">
      <div className="max-w-7xl mx-auto px-6 text-center">
        <h2 className="text-3xl font-bold mb-12">Meta Ads Pricing</h2>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <SimpleCard title="Starter" price="$249" />
          <SimpleCard popular title="Standard" price="$449" />
          <SimpleCard title="Premium" price="15%" />
        </div>
      </div>
    </section>
  );
    ...
    <section className="py-20">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <FAQItem
          ...
          answer="No. Everything is transparent."
        />
        <FAQItem
          question="Can I get a custom quote?"
          answer="Yes. We offer custom pricing."
        />
        <FAQItem
          question="Do you offer long-term discounts?"
          answer="Yes, discounts apply for long-term contracts."
        />
      </div>
    </section>
  );
